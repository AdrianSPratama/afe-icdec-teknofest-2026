...
N 290 -605 290 -585 {lab=outp}
N 290 -525 290 -505 {lab=GND}
N 290 -600 470 -600 {lab=outp}
N 830 -605 830 -585 {lab=outn}
N 830 -525 830 -505 {lab=GND}
N 650 -600 830 -600 {lab=outn}
...
C {lab_pin.sym} 470 -730 0 0 {name=p12 sig_type=std_logic lab=vdd}
C {lab_pin.sym} 650 -730 0 0 {name=p18 sig_type=std_logic lab=vdd}
...
device=resistor
m=1}
C {capa.sym} 290 -555 0 0 {name=C1
m=1
value=20f
footprint=1206
device="ceramic capacitor"}
C {gnd.sym} 290 -505 0 0 {name=l5 lab=GND}
C {capa.sym} 830 -555 0 0 {name=C2
m=1
value=20f
footprint=1206
device="ceramic capacitor"}
C {gnd.sym} 830 -505 0 0 {name=l3 lab=GND}
