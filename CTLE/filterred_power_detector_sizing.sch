...
N 640 -700 640 -680 {lab=Vout_neg}
N 730 -730 730 -700 {lab=Vout_neg}
N 820 -700 820 -680 {lab=Vout_neg}
N 730 -700 820 -700 {lab=Vout_neg}
N 640 -700 730 -700 {lab=Vout_neg}
...
N 630 -730 730 -730 {lab=Vout_neg}
N 530 -740 530 -730 {lab=voutp}
N 630 -740 630 -730 {lab=Vout_neg}
...
N 730 -740 730 -730 {lab=Vout_neg}
N 410 -730 530 -730 {lab=voutp}
N 610 -730 630 -730 {lab=Vout_neg}
N 110 -450 110 -400 {lab=Vhf_pos}
N 400 -450 400 -400 {lab=Vhf_neg}
N 250 -400 270 -400 {lab=#net2}
N 250 -310 270 -310 {lab=vcmref}
N 260 -400 260 -330 {lab=#net2}
N 260 -320 260 -290 {lab=#net2}
...
N 270 -400 300 -400 {lab=#net2}
N 360 -400 400 -400 {lab=Vhf_neg}
N 220 -400 250 -400 {lab=#net2}
...
C {sky130_fd_pr/res_high_po_5p73.sym} 330 -400 3 0 {name=R9
L=69.65
model=res_high_po_5p73
spiceprefix=X
mult=4}
C {sky130_fd_pr/res_high_po_5p73.sym} 190 -400 3 0 {name=R3
L=69.65
model=res_high_po_5p73
spiceprefix=X
mult=4}
C {sky130_fd_pr/res_high_po_5p73.sym} 330 -310 1 0 {name=R4
L=708
model=res_high_po_5p73
spiceprefix=X
mult=4}
C {sky130_fd_pr/res_high_po_5p73.sym} 190 -310 1 0 {name=R5
L=708
model=res_high_po_5p73
spiceprefix=X
mult=4}
C {sky130_fd_pr/cap_mim_m3_1.sym} 260 -250 0 0 {name=C4 model=cap_mim_m3_1 W=0.4208 L=0.4208 MF=1 spiceprefix=X}
C {sky130_fd_pr/res_high_po_5p73.sym} 770 -340 2 0 {name=R6
L=69.65
model=res_high_po_5p73
spiceprefix=X
mult=4}
C {sky130_fd_pr/res_high_po_5p73.sym} 920 -340 0 0 {name=R7
L=69.65
model=res_high_po_5p73
spiceprefix=X
mult=4}
