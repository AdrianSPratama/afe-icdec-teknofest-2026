...
N 370 -440 420 -440 {lab=OUT}
N 420 -740 420 -440 {lab=OUT}
N 420 -740 500 -740 {lab=OUT}
N 500 -740 550 -740 {lab=OUT}
...
C {vsource.sym} 1090 -570 0 0 {name=V1 value="PWL( 0 0   1m 1.8   5m 1.8 )" savecurrent=false}
C {vsource.sym} 1310 -570 0 0 {name=V2 value=0 savecurrent=false}
...
C {lab_pin.sym} 550 -740 0 1 {name=p6 sig_type=std_logic lab=OUT}
...
C {capa-2.sym} 520 -710 0 0 {name=C1
m=1
value=50p
footprint=1206
device=polarized_capacitor}
C {lab_pin.sym} 520 -680 0 1 {name=p5 sig_type=std_logic lab=VSS}
