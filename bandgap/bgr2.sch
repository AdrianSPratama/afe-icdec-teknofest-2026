...
Startup Circuit dianggep nggak ada, tapi ngebantu biar BGR core gak terjebak di zero-current state} 1040 -210 0 0 0.4 0.4 {}
N 150 -530 370 -530 {lab=VDD}
N 310 -500 330 -500 {lab=OUT1}
N 260 -500 260 -440 {lab=OUT1}
N 370 -470 370 -440 {lab=OUT}
N 370 -380 370 -320 {lab=VBE2}
N 150 -470 150 -320 {lab=#net1}
...
N 150 -320 150 -310 {lab=#net1}
N 280 -320 370 -320 {lab=VBE2}
N 150 -320 240 -320 {lab=#net1}
N 310 -360 320 -360 {lab=VDD}
N 200 -360 210 -360 {lab=VSS}
N 1210 -540 1210 -530 {lab=GND}
N 60 -530 150 -530 {lab=VDD}
N 60 -150 150 -150 {lab=VSS}
N 370 -310 370 -230 {lab=VBE2}
N 460 -500 490 -500 {lab=OUT1}
N 380 -510 390 -500 {lab=OUT1}
N 320 -510 380 -510 {lab=OUT1}
N 310 -500 320 -510 {lab=OUT1}
N 370 -530 530 -530 {lab=VDD}
N 530 -330 530 -150 {lab=VSS}
N 370 -150 530 -150 {lab=VSS}
N 530 -470 530 -390 {lab=#net2}
N 460 -500 460 -430 {lab=OUT1}
N 460 -430 660 -430 {lab=OUT1}
N 660 -430 660 -390 {lab=OUT1}
...
N 190 -500 260 -500 {lab=OUT1}
N 150 -150 220 -150 {lab=VSS}
N 220 -150 300 -150 {lab=VSS}
N 260 -500 310 -500 {lab=OUT1}
N 390 -500 460 -500 {lab=OUT1}
...
C {vsource.sym} 1090 -570 0 0 {name=V1 value=1.8 savecurrent=false}
C {vsource.sym} 1210 -570 0 0 {name=V2 value=0 savecurrent=false}
C {lab_pin.sym} 1090 -540 0 0 {name=p7 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 1210 -600 0 0 {name=p8 sig_type=std_logic lab=VSS}
C {gnd.sym} 1210 -530 0 0 {name=l1 lab=GND}
...
C {code_shown.sym} 1190 -430 0 0 {name=s1 only_toplevel=false value="
...
C {lab_pin.sym} 370 -450 0 1 {name=p5 sig_type=std_logic lab=OUT}
C {lab_pin.sym} 260 -470 0 1 {name=p6 sig_type=std_logic lab=OUT1}
